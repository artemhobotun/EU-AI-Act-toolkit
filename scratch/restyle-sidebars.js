    ...
    <div class="nav-section">
      ...
      <nav>
        <ul>
          ...
          <li><a href="packs.html#packs-progress-container"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="nav-icon"><path d="m9 11-6 6v3h3l6-6"></path><path d="m18 2 4 4-12 12H6v-4L18 2Z"></path></svg> Workspace Progress</a></li>
        </ul>
      </nav>
    </div>
    ...
    <div class="sidebar-footer">
      ...
      <nav>
        <ul>
          ...
          <li><a href="changelog.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="nav-icon"><path d="M12 20h9"></path><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"></path></svg> Changelog</a></li>
        </ul>
      </nav>
    </div>
  </aside>`;
